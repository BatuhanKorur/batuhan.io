...
<template>
  <svg width="375" height="720" viewBox="0 0 375 720" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <defs>
      <filter
        id="filter0_f_56_2416" x="-50.1006" y="111.966" width="648.102" height="619.489"
      ...
      <filter
        id="filter1_f_56_2416" x="-189" y="0.152924" width="638.554" height="592.822"
        filterUnits="userSpaceOnUse" color-interpolation-filters="sRGB"
      >
        <feFlood flood-opacity="0" result="BackgroundImageFix" />
        <feBlend mode="normal" in="SourceGraphic" in2="BackgroundImageFix" result="shape" />
